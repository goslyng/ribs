...
%         ribsInhGroundTruth=ribsExh;{[],[],[],[],[],[],[],[],[],[]};
        ang(r,5) = ang0(r,5);
        [tmp R]= displayAngles(settings,ribsExh,ang(r,:),firstPts,ribsInhGroundTruth,r,ang(r,5),offsets_inital,false);
        if cycle<1
...
[a_(r), b_(r) ,c_(r)]=findEulerO(rot_mat'*R*rot_mat,[ 3 1 2 ],1);
