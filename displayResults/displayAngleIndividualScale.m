...
%     resultPath{i} = [paths.rootPath 'Ribs/ang_' 'scale' num2str(scale)  '_sigma'  num2str(10*settings.hw_sigma(i),'%02d')  '_' num2str(m)];

%     ang_scale1_sigma03_50
...
% for m=mriSubjects
    [ptsI, rib_nos]=loadRibVTKFiles(paths.dataPath,m,settings.ap,settings.is,settings.lr,inh);
