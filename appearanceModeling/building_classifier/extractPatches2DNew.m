function   [ribPatches,nonRibPatches , validPts] = extractPatches2DNew(im, ribPts, patch_size,debugMode)
...
%             fprintf(1,'%d  ',rib);
            ...
            ribPatches{i} =  extractPatchesRibs2D(im{i},pts,patch_size,debugMode.treePaths{i});
                ...
                [ribPatches{i}, validPts{i}]= extractPatchesRibs2D(im{i},pts,patch_size);
            end
