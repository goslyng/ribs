...
settings.mriSubjects =[50:54 550 56:59 60 61 63 64 65 66];%[56:59];
settings.allSubjects =[18 19 23:28 31 33:34 50:54 550 56:59 60 61 63 64 65 66];%[56:59];

settings.ctSubjects=1:20;
settings.ctRibNumbers = 1:24;
settings.rightRibs = 1:2:24;
settings.testRibs = 7:10;
settings.testRibs2 = settings.rightRibs(settings.testRibs);

settings.ct_ap = [-1   0  0];
settings.ct_is = [ 0   0 -1];
settings.ct_lr = [ 0  -1  0];

% displayImages=1;

settings.numKnots=100;
%Angle Point Reparameterization
settings.numKnots1=20;
settings.numKnots2=80;

settings.numKnotsVertebra = 100;

settings.nCompsAngle = 5;
settings.nCompsShape = 6;

settings.nCompsRibCage = 2;
settings.nCompsLength = 2;

nn=1;
settings.anglePointRange=1:40;
...
settings.treeName = 'tree_cntr2_' ;

settings.numTrees = 500;
settings.side='Right';
settings.postFix = '_R_678910.txt';
...
settings.inh = 0; % default value for considering the inhalation volumes
